...
export const ImageUploader = ({ onUpload }: { onUpload: (url: string) => void }) => {
  ...
  return (
    ...
    >
      <Icon
        name="Image"
        className="w-12 h-12 mb-4 text-black dark:text-white opacity-20 font-sans"
      />
      <div className="flex flex-col items-center justify-center gap-2">
        <div className="text-sm font-medium text-center text-neutral-400 dark:text-neutral-500 font-sans">
